...
class Test_CheckTransactionBillPayment extends TestCase
{
    ...
    public function testShouldReturnAsExpected($config, $expected) {
        ...
        $data = $this->api->checkTransactionBillPayment($config['reference1'], $config['reference2'], $config['transaction_time']);
